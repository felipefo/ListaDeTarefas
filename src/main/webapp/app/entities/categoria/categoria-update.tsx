...
export const CategoriaUpdate = (props: ICategoriaUpdateProps) => {
  ...
  const { categoriaEntity, users, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="listaDeTarefasApp.categoria.home.createOrEditLabel" data-cy="CategoriaCreateUpdateHeading">
            <Translate contentKey="listaDeTarefasApp.categoria.home.createOrEditLabel">Create or edit a Categoria</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : categoriaEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="descricaoLabel" for="categoria-descricao">
                  <Translate contentKey="listaDeTarefasApp.categoria.descricao">Descricao</Translate>
                </Label>
                <AvField

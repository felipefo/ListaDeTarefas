...
export const Categoria = (props: ICategoriaProps) => {
  ...
  const { categoriaList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="categoria-heading" data-cy="CategoriaHeading">
        <Translate contentKey="listaDeTarefasApp.categoria.home.title">Categorias</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="listaDeTarefasApp.categoria.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="listaDeTarefasApp.categoria.home.createLabel">Create new Categoria</Translate>
          </Link>
        </div>
      </h2>
        ...
        {categoriaList && categoriaList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="listaDeTarefasApp.categoria.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${categoria.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${categoria.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="listaDeTarefasApp.categoria.home.notFound">No Categorias found</Translate>
            </div>
          )
        )}
      </div>
